...
class CallbackDataManager:
    ...
    def create_callback_data(self, action: str, file_id: str, mode: str, preset: Optional[str] = None) -> str:
        ...
        logger.debug(f"Created callback data: {callback_data} ({len(callback_data.encode('utf-8'))} bytes)")
