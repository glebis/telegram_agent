...
class KeyboardUtils:
    ...
    def create_reanalysis_keyboard(
        ...
        if current_mode == "default":
            ...
            buttons.append(InlineKeyboardButton("📝 Quick Analysis", callback_data=callback_data))
    ...
    def create_mode_selection_keyboard(
        ...
        # Default mode button
        if current_mode != "default":
            buttons.append(InlineKeyboardButton("📝 Quick Analysis", callback_data="mode:default:"))
    ...
    def create_confirmation_keyboard(self, action: str, data: str) -> InlineKeyboardMarkup:
    ...
    @staticmethod
    def create_simple_keyboard(buttons_data: List[Tuple[str, str]], max_per_row: int = 2) -> InlineKeyboardMarkup:
        """Create a simple keyboard from button data tuples (text, callback_data)"""
        
        buttons = [InlineKeyboardButton(text, callback_data=data) for text, data in buttons_data]
