...
class CacheService:
    ...
    def _generate_cache_key(self, file_id: str, mode: str, preset: Optional[str] = None) -> str:
    ...
    async def get_cached_analysis(self, file_id: str, mode: str, preset: Optional[str] = None) -> Optional[Dict]:
        ...
        try:
            async with get_db_session() as session:
                ...
                if cached_image and cached_image.analysis:
                    logger.info(f"Cache hit for file_id={file_id}, mode={mode}, preset={preset}")
                ...
                logger.info(f"Cache miss for file_id={file_id}, mode={mode}, preset={preset}")
                return None
    ...
    async def store_analysis(self, file_id: str, mode: str, preset: Optional[str], analysis: Dict) -> bool:
