...
def test_user_model_has_consent_fields():
    ...
    assert hasattr(User, "consent_given_at"), "User model missing consent_given_at field"
...
def test_user_settings_has_health_consent():
    ...
    assert hasattr(UserSettings, "health_data_consent"), (
...
def test_encryption_utility_exists():
    ...
    from src.utils.encryption import encrypt_field, decrypt_field, is_encrypted
